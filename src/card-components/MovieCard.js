  ...
  console.log(this.props)
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront moviePoster={posterMap[this.props.poster]}/>
        <CardBack movieTitle={this.props.title} movieRating={this.props.rating} movieGenres={this.props.genres}/>
      </div>
    )
  }
}
